...
public abstract class AbstractDefaultFeatureValueProvider implements IDefaultFeatureValueProvider {
	...
	protected boolean exists(String path) {
		return fsa.getURI(path)!=null;
	}
	
	//TODO the concept 'project' isn't the right level for this API, because its EFS specific
	protected String getTargetProjectName(EObject contextElement) {
		URI uri = contextElement.eResource().getURI();
