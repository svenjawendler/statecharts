...
public class StringConcatenationStatemachine
		implements
			IStringConcatenationStatemachine {
	...
	public StringConcatenationStatemachine() {
	...
	public String getLastword() {
		return sCInterface.getLastword();
	}

	public void setLastword(String value) {
		sCInterface.setLastword(value);
	}
	...
	/* Entry action for statechart 'StringConcatenation'. */
	private void entryAction() {
	}

	/* Entry action for state 'B'. */
	private void entryAction_main_region_B() {
		sCInterface.word = sCInterface.anotherword + "_test_" + "_23";
	}

	/* Entry action for state 'C'. */
	private void entryAction_main_region_C() {
		sCInterface.lastword = sCInterface.anotherword + "AS";
	}

	/* Exit action for state 'StringConcatenation'. */
